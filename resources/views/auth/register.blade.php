...
@section('content')
    ...
    <div class="container">
        {{-- @php
            $step = request()->query('step', 1); // Default adalah step 1
        @endphp

        <x-progress-tracker :step="$step" /> --}}
                ...
                <div class="p-5 auth-card mb-5">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <input id="name" type="text"
                            class="form-control font-21 p-3 @error('name') is-invalid @enderror" name="name"
                        ...
                        <input id="email" type="email"
                            class="form-control font-21 p-3 @error('email') is-invalid @enderror" name="email"
                        ...
                        <input id="phone" type="tel"
                            class="form-control font-21 p-3 @error('phone') is-invalid @enderror" name="phone"
                        ...
                        <input id="password" type="password"
                            class="form-control font-21 p-3 @error('password') is-invalid @enderror" name="password"
                        ...
                        <label for="password-confirm"
                            class="col-md-4 col-form-label font-21 mt-4">{{ __('Confirm Password') }}</label>
                        <input id="password-confirm" type="password" class="form-control font-21 p-3"
                        ...
                        {{-- login --}}
                        <p class="text-center font-21 mt-3">Sudah punya akun? <a href="{{ route('login') }}"
