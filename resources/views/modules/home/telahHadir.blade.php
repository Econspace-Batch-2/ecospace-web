<div class="pt-20 mx-auto text-center overflow-hidden">
    ...
    <div class="flex gap-x-2 sm:gap-x-4 md:gap-x-6 lg:gap-x-8 justify-center py-8 md:py-12 px-4 overflow-x-auto">
        <img src="{{ asset('assets/home/unair.svg') }}" class="w-[40px] sm:w-[80px] md:w-[100px] lg:max-w-[240px] object-contain" />
        <img src="{{ asset('assets/home/ugm.svg') }}" class="w-[40px] sm:w-[80px] md:w-[100px] lg:max-w-[240px] object-contain" />
        <img src="{{ asset('assets/home/unbraw.svg') }}" class="w-[40px] sm:w-[80px] md:w-[100px] lg:max-w-[240px] object-contain" />
        <img src="{{ asset('assets/home/binus.svg') }}" class="w-[40px] sm:w-[80px] md:w-[100px] lg:max-w-[240px] object-contain" />
        <img src="{{ asset('assets/home/ui.svg') }}" class="w-[40px] sm:w-[80px] md:w-[100px] lg:max-w-[240px] object-contain" />
    </div>
</div>