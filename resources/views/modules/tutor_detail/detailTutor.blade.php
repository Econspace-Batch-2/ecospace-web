...
@section('content')
    ...
    <div class="desktop container-fluid mt-3">
        <div class="container">
            <img loading="lazy" src="{{ asset('assets/tutorDetail/course_banner.svg') }}" alt="course banner"
                class="img-fluid w-100 rounded-4">
        </div>
    </div>
    <!-- Profil Tutor -->
    <div class="mt-5 pl-9">
        <p class="text-3xl font-bold mb-5">Profil Tutor</p>
        <div class="overflow-x-auto flex flex-row space-x-4">
            <div class="w-full md:w-[24rem] min-h-[32rem]  bg-white rounded-3xl shadow-lg relative overflow-hidden flex-shrink-0">
                <!-- Background design elements -->
                <div class="absolute inset-0 bg-[#5F9E99] rounded-3xl overflow-hidden">
                    <div class="relative h-full w-full flex items-center justify-center">
                        <img src="{{ asset('assets/background/card-bg-orange.svg') }}" alt="Background Design"
                            class="absolute top-0 left-0 w-full h-1/2 object-cover">
                    </div>
                </div>

                <!-- Profile Image -->
                <div class="h-64 z-10 flex justify-center -mt-12">
                    <img src="{{ asset('assets/tutorImage/daffa.svg') }}" alt="Profile Image"
                        class="absolute top-1/4 h-24 object-cover scale-[3]">
                </div>

                <!-- Name and Title -->
                <div class="relative z-30 text-center mt-4">
                    <div class="w-3/4 bg-gray-800 text-white px-4 py-1 rounded-full inline-block">
                        <h2 class="font-semibold text-lg">Heri</h2>
                        <p class="text-sm">Master of Accounting</p>
                    </div>
                </div>

                <div class="absolute top-1/2 w-full h-full z-20 bg-[#B1ECE7] rounded-tl-[15%]">
                    <!-- Section Title -->
                    <div class="relative px-4 z-40 text-start pt-12">
                        <h3 class="text-lg font-semibold text-gray-800 text-center">Pengalaman dan Prestasi</h3>
                        <!-- Experience List -->
                        <ul class="mt-4 text-gray-600 space-y-2">
                            <li class="flex items-start">
                                <span class="text-orange-500 mr-2">▶</span>
                                <span>Juara 1 International Accounting Competition 2020</span>
                            </li>
                            <li class="flex items-start">
                                <span class="text-orange-500 mr-2">▶</span>
                                <span>20 tahun bekerja sebagai akuntan</span>
                            </li>
                            <li class="flex items-start">
                                <span class="text-orange-500 mr-2">▶</span>
                                <span>Tampan dan berani</span>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-6 align-self-center">
                    <p class="font-21 font-400 mb-2"><a href="{{ route('viewTutors') }}">Academy</a> >
                    ...
                    <img loading="lazy" src="{{ asset('assets/courseInside/' . $subject->subject_image) }}"
                        alt="{{ $subject->subject_image }}" class="img-fluid w-100 rounded-4 mobile mb-2">
                    ...
                    <div class="d-flex justify-content-left gap-3 mb-md-2">
                        <p class="font-18 font-400"><i class="fa-solid fa-folder me-2"></i>
                            {{ $subject->subject_category }}
                        </p>
                        <p class="font-18 font-400"><i class="fa-solid fa-gem me-2"></i> {{ $subject->subject_semester }}
                        </p>
                    </div>
                    <a target="_blank" class="bg-orange rounded-3 border-0 font-30 font-500 text-white px-5 py-2"
                        href="https://bit.ly/RegistrationTutorService">
                        Mulai Belajar
                    </a>
                </div>
                ...
                <div class="col-12 col-md-4">
                    <div>
                        ...
                        <div class="border border-2 rounded-4 pt-3 px-4">
                            ...
                            <button class="font-400 font-22 bg-lightblue border-0 rounded-3 px-3 py-2 mt-3"
                                onclick="redirectTo('https://docs.google.com/spreadsheets/d/1rQ0ZhU6Ykdu4lrhhKMoHInTBQI2ywafQ0PnWIxZG-9w/edit?usp=sharing')">Click
                                Here for Tutor Details</button>
                        ...
                        <div class="border border-2 rounded-4 mt-4 py-3 px-4">
                            ...
                            <div class="d-flex justify-content-left gap-2">
                                ...
                                <p class="font-20 font-500 align-self-center mt-2" style="height: 100%">Expert Tutor yang
                            ...
                            <div class="d-flex justify-content-left gap-2 mt-2">
                                ...
                                <p class="font-20 font-500 align-self-center mt-2" style="height: 100%">Sistem Mahasiswa
                                    to
                                    Mahasiswa, sehingga bahasan materi menjadi lebih tepat & relatable</p>
                            </div>
                            <div class="d-flex justify-content-left gap-2 mt-2">
                                <img loading="lazy" src="{{ asset('assets/tutorDetail/benefit3.svg') }}"
                                    class="img-fluid img-benefit" alt="benefit icon">
                                <p class="font-20 font-500 align-self-center">3. </p>
                                <p class="font-20 font-500 align-self-center mt-2" style="height: 100%">Konsultasi Materi
