...
<div class="w-full flex -mt-8 justify-center">
    <div
        class="w-11/12 lg:w-fit flex flex-col xl:flex-row justify-center items-center gap-4 py-3 px-4 h-fit bg-blue-950 rounded-xl">
            ...
            <form action="{{ route('filterTutor') }}" method="GET">
                <div class="flex flex-col items-center justify-center md:flex-row gap-2 md:gap-4">
                    ...
                    <div class="w-full md:min-w-fit relative">
                        <select name="univ" id="course" class="w-full rounded-lg py-2 px-3 appearance-none pr-10">
                            <option value="all" style="background-color: white;" @if(old('univ', $univ) == 'all') selected
                            @endif>
                                Semua Universitas
                            </option>
                            ...
                            <option value="UGM" style="background-color: white;" @if(old('univ', $univ) == 'UGM') selected
                            @endif>
                    ...
                    <!-- Major Filter -->
                    <div class="w-full md:min-w-fit relative">
                        <select name="major" id="course" class="w-full rounded-lg py-2 px-3 appearance-none pr-16">
                    ...
                    <!-- Semester Filter -->
                    <div class="w-full md:min-w-fit relative">
                        <select name="semester" id="course" class="w-full rounded-lg py-2 px-3 appearance-none pr-16">
        ...
        <div class="flex flex-col md:flex-row gap-2 w-full items-center justify-center">
            <button id="pilih" class="bg-orange text-white rounded-lg py-2 px-6 w-full" type="submit">
                Pilih
            </button>
            <form action="{{ route('clearFilters') }}" method="GET" class="w-full">
                <button id="hapus" class="bg-white border-none rounded-lg py-2 px-6 w-full whitespace-nowrap"
                    type="submit">
