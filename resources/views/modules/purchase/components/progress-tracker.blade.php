...
<div class="flex items-center justify-center text-center w-full my-5">
    @php
        $steps = [
    ...
    @endphp
    <div class="w-full max-w-[80%] lg:max-w-[50%] flex items-center justify-center bg-white md:shadow-md py-16 md:py-10 pb-20 md:pb-20 md:border-2 border-gray-100">
        <ol style="box-shadow"
            class="flex w-full max-w-[80%] bg-white sm:rounded-lg text-xs sm:text-base">
                    ...
                    @if ($index + 1 == $step)
                        <li class="flex items-end w-fit">
                            <div class="flex flex-col justify-center items-center z-10">
                                ...
                                <p class="text-[#FF8412] absolute translate-y-12 text-center font-normal text-xs md:text-sm">
                                    {{ $stepItem['label'] }}
                                </p>
                            </div>
                        </li>
                    @else
                        <li class="flex items-end w-fit">
                            <div class="flex flex-col justify-center items-center z-10">
                                ...
                                <p class="text-[#D5D5D5] absolute translate-y-12 text-center font-normal text-xs md:text-sm">
                                    {{ $stepItem['label'] }}
                                </p>
                            </div>
                        </li>
                        ...
                        <span
                            ...
                            @if ($index + 1 == $step)
                                <div class="flex flex-col justify-center items-center z-10">
                                    ...
                                    <p class="text-[#FF8412] absolute {{$translateAllignment}} text-center text-xs md:text-sm">{{ $stepItem['label'] }}
                                    </p>
                                </div>
                            @elseif($index < $step)
                                <div class="flex flex-col justify-center items-center z-10">
                                    ...
                                    <p class="absolute {{$translateAllignment}} text-[#FF8412] text-center text-xs md:text-sm">{{ $stepItem['label'] }}
                                    </p>
                                </div>
                            @else
                                <div class="flex flex-col justify-center items-center z-10">
                                    ...
                                    <p class="text-[#D5D5D5] absolute {{$translateAllignment}} text-center text-xs md:text-sm">{{ $stepItem['label'] }}
                                    </p>
                                </div>
                            @endif
                        </span>
